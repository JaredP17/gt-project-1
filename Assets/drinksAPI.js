$(document).ready(function () {
  // generating random drinks on click of a location button
  ...
  //generating a new drink on click of the "Want Another Drink?" button
  $("#new-drink-button").on("click", function () {
    var randomDrinkURL =
      "https://www.thecocktaildb.com/api/json/v1/1/random.php";
    $.ajax({
      url: randomDrinkURL,
